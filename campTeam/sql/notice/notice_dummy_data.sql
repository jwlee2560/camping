-- 공지글 더미 데이터
CREATE OR REPLACE PROCEDURE project_dummy_notice_gen_proc
IS
 	TYPE v_subject_array IS VARRAY(10) OF nvarchar2(100);
    TYPE v_content_array IS VARRAY(10) OF nvarchar2(1000);
    v_id varchar2(20);
...
exec project_dummy_notice_gen_proc;