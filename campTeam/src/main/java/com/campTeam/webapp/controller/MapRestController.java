...
public class MapRestController {
	...
	public ResponseEntity<Object> mapRestService(@RequestParam("region") String region,
		...
		switch (thema) {
			case "체험시설" : searchColumn = "surr_facil_youth_experience"; searchColumnVal = "시설 주변 물놀이(청소년체험시설) 있음"; break;
			...
			case "산책로" : searchColumn = "surr_facil_trail"; searchColumnVal = "시설 주변 산책로 있음"; break;
			case "수상레저" : searchColumn = "surr_facil_pool"; searchColumnVal = "주변 시설 물놀이(수영장)"; break;
